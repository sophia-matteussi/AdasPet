...
namespace AdasPet
{
    public class Startup
    {
        ...
        // Configura os servi�os do ASPNET
        // � rodado no come�o do programa
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSession(options =>
            {
                ...
                // Quando expira perde tudo na sess�o
                options.IdleTimeout = TimeSpan.FromHours(2);
                // Indica se o cookie pode ser acessado pelo browser/cliente
                options.Cookie.HttpOnly = true;
                // Indica se o cookie � essencial para o funcionamento do site
            ...
            // Adiciona uma pagina para quando opera��es no banco de dados d�o erro
            services.AddDatabaseDeveloperPageExceptionFilter();

            // Adiciona o identity framework para autentica��o e autoriza��o
            services.AddDefaultIdentity<IdentityUser>(options => options.SignIn.RequireConfirmedAccount = true)
                //Adiciona Roles para autoriza��o
                .AddRoles<IdentityRole>()
                // Adicionamos nosso contexto de BD para o identity guardar suas iniforma��es
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute(
                    // Diz qual a rota padr�o/pagina inicial
                    name: "default",
