        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        _logger.LogInformation("Usuário criou uma conta usando {Name} provedor.", info.LoginProvider);
                        ...
                        await _emailSender.SendEmailAsync(Input.Email, "Confirm your email",
                            $"Por favor, confirme a sua conta de e-mail <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'> clicando aqui</a>.");
